...
public static var overworldDialougeBox:FlxSprite;

public static var events = [];
public static var eventName:String = "";
public static var conditionFunction;
public static function manageEventList(tag:String) {
	if (events[tag] != null)
		events[tag] = [];
	eventName = tag;
}
...
static var textTimer:FlxTimer;
public static function doTextStuff(?str:String = "", ?keepText:Bool = false, ?noAccept:Bool = false, ?soundPath:String = null, ?graphicPath:String = null, ?offset:Float = 0.05){
